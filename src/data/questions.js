export const questions = [
  ...
  {
    id: 2,
    pertanyaan: "Waktu pertama kali kita nge-date itu, kita sholat bareng, sholat apa?",
    jawabanBenar: "Ashar",
    clueSalah: "Coba ingat lagi, waktu itu shalat antara dhuhur dan Maghrib.",
    pesanSkip: "Masa lupa sih? Hahaha, skip yuk! "
  },
  {
    id: 3,
  ...
  },
  {
    ...
    pesanSkip: "Benda yang kalau ilang bikin satu rumah heboh nyarinya... Masa lupa sih, Istriku sayang? Skip aja! 🔑😂"
  },
  {
    id: 9,
    pertanyaan: "Kalau kita lagi ngobrol berdua di rumah, siapa di antara kita yang biasanya paling cepat ketiduran?",
    jawabanBenar: "kamu",
    clueSalah: "Isi antara 'aku' atau 'kamu'. Yang baru ngobrol 5 menit matanya sudah merem!",
    pesanSkip: "Yang baru ngonbrol 5 menit udah sampai jember... Hayoo ngaku! Skip aja ya biar lanjut... 🍿💤"
  },
  {
    id: 10,
    ...
    pesanSkip: "Kebangetan banget kalau lupa anniversary yang ke-berapa! Ketik angka 2 aja sayang, atau skip langsung deh! 🎂🤣"
  }
];
